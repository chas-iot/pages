...
find js -type f -exec shasum --algorithm 256 {} \; >> SHA256SUMS
find images -type f -exec shasum --algorithm 256 {} \; >> SHA256SUMS
find src -type f -exec shasum --algorithm 256 {} \; >> SHA256SUMS
find views -type f -exec shasum --algorithm 256 {} \; >> SHA256SUMS
